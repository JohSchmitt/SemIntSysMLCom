...
# Load predictor
predictor = TabularPredictor.load("./regr_model/")

# Load test data
X_test = dat.getData("regr", "test")
...
k_export.to_csv('./_predictions/pre_regr_autogl_'+now.strftime("%d.%m.%Y_%H.%M.%S")+'.csv', index=False)